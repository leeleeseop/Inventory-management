...
create table products (
    ...
    --상품수량 ( 상품 0개 이하는 못 넣음 )
    product_quantity number check (product_quantity >= 0) not null,
    
    --상품가격 ( 상품의 가격은 0원이상 )
    product_price number(10,2) check (product_price >= 0),
...
-- 샘플데이터 상품 업데이트
update products set product_quantity=50 where product_no  = 1;
